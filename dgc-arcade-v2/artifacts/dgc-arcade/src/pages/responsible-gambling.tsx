    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-invert max-w-none space-y-8 text-sm text-muted-foreground leading-relaxed">
        ...
        <section>
          ...
          <p>DGC Arcade is operated by DGC Arcade Ltd. as a licensed gaming platform. We are committed to providing a safe and responsible gaming environment. Play should always be entertaining — never a way to make money or escape problems.</p>
        </section>
