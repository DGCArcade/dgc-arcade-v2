...
> = [
  ...
  (username, code) => {
    ...
    const body = `
      ...
      ${codeBox("Your 6-Digit Code", code, "⏱️ Expires in 24 hours", accent)}
  ...
  (username, code) => {
    ...
    const body = `
      ...
      ${codeBox("6-Digit Verification Code", code, "⏱️ Good for the next 24 hours", accent)}
  ...
  (username, code) => {
    ...
    const body = `
      ...
      ${codeBox(">> 6-DIGIT ACCESS KEY", code, "EXPIRES: 24:00:00", accent)}
