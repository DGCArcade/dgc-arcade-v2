    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-invert max-w-none space-y-8 text-sm text-muted-foreground leading-relaxed">
        ...
        <section>
          ...
          <p>DGC Arcade is operated by Medium Rare N.V. and licensed by the Curaçao Gaming Authority. We are committed to providing a safe and responsible gambling environment. Gambling should always be entertaining — never a way to make money or escape problems.</p>
        </section>
